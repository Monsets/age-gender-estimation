...
def parse_args():
  ...
  parser.add_argument('--prefix', default='../model_ag/model_ag', help='directory to save model_ag.')
  parser.add_argument('--pretrained', default='', help='pretrained model_ag to load')
  ...
  parser.add_argument('--verbose', type=int, default=2000, help='do verification testing and model_ag saving every verbose batches')
